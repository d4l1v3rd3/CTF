...
[Lookup](https://github.com/d4l1v3rd3/CTF/blob/main/easy/Lookup-THM.md) | Enumeration Login - Hydra - Subdomain - elFinder Vulnb - pwm Exploit - look Escala | FÁCIL | THM | LINUX | <img width=50px height=50px src="https://github.com/user-attachments/assets/e2b42a61-8200-4b95-9dcc-417aa2ea72be">
[Silver PLatter](https://github.com/d4l1v3rd3/CTF/blob/main/easy/Silver_Platter-THM.md) | Enumeración FFUF 8080 - Silverpeas Vuln / Auth / Mensajes - SSH - Enumeración Auth.log | FÁCIL | THM | LINUX | <img width=50px height=50px src="https://github.com/user-attachments/assets/e38f68d1-f9df-450c-b569-2b31c3d0010f">  
...
[Hammer](https://github.com/d4l1v3rd3/CTF/blob/main/Medium/Hammer-THM.md) | Scanning -p- - Enumeration FFUF + Bypass Reset_password + Ffuf Post  + Python Script - Network Administrador de navegador + Copy CUrl - JwToken Manipulation | MEDIO | THM | LINUX | <img width=50px height=50px src="https://github.com/user-attachments/assets/bdc79318-7864-4bcd-929a-3fd40c44780b">
...
[Breakme](https://github.com/d4l1v3rd3/CTF/blob/main/Medium/Breakme-THM.md) | MÁQUINA SUPER IMPORTANTE PARA VER!!!! - Wordpress - Pivoting - SshKeys - Tunnelink - Apache enumeration - etc | MEDIO / DIFICIL | THM | LINUX | <img width=50px height=50px src="https://github.com/user-attachments/assets/7956f4da-1990-45f1-84fa-07e7fff1349b">
